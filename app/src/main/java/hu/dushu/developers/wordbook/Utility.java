...
public class Utility {
    ...
    public static String getFriendlyDayString(Context context, String dateStr) {
        ...
        String todayStr = WordContract.getDbDateString(todayDate);
        Date inputDate = WordContract.getDateFromDb(dateStr);
        ...
        if (todayStr.equals(dateStr)) {
            ...
            String weekFutureString = WordContract.getDbDateString(cal.getTime());
    ...
    public static String getDayName(Context context, String dateStr) {
        ...
        try {
            ...
            // day name.
            if (WordContract.getDbDateString(todayDate).equals(dateStr)) {
                ...
                if (WordContract.getDbDateString(tomorrowDate).equals(
                        dateStr)) {
